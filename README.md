...
```javascript
import csrot from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-csrot-wasm@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-csrot-wasm@deno/mod.js';
```
