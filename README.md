...
```javascript
import csrot from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-csrot-wasm@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { Module } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-csrot-wasm@esm/index.mjs';
```
