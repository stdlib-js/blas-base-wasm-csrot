...
var g=require('@stdlib/assert-is-wasm-memory/dist'),M=require('@stdlib/utils-define-nonenumerable-read-only-property/dist'),j=require('@stdlib/utils-inherit/dist'),_=require('@stdlib/wasm-module-wrapper/dist'),z=require('@stdlib/error-tools-fmtprodmsg/dist'),D=E();function c(e){if(!(this instanceof c))return new c(e);if(!g(e))throw new TypeError(z('26RH0',e));return _.call(this,D,e,{env:{memory:e}}),this}j(c,_);M(c.prototype,"main",function(r,s,i,a,t,n,u){return this._instance.exports.c_csrot(r,s,i,a,t,n,u),a});M(c.prototype,"ndarray",function(r,s,i,a,t,n,u,d,q){return this._instance.exports.c_csrot_ndarray(r,s,i,a,t,n,u,d,q),t});R.exports=c
